...
public class RulePARENLogic extends PuzzleRule {

	public RulePARENLogic() {
		setName("PAREN Logic");
		description = "A PAREN Value is the same value as the logic symbol enclosed within it.";
	...
	{
		//check if the changed value is the same as the logic value within it.
